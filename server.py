"""Linkup web-search MCP server (SSE on port 8080).

Identical in spirit to the original repo's server.py. Nothing here touches an
LLM, so it needs no changes for NVIDIA.
"""
